<%-- 
    Document   : templete
    Created on : 16 Dec, 2015, 8:32:42 PM
    Author     : Tarequzzaman
--%>
            ...
            <div class="well">
                <div class="container">
                    ...
                    <div class="col-lg-8">
                        ...
                        <form action="student_validity" class="form-horizontal" onsubmit="return myfunction()" method="post">
                            <div class="col-lg-12">

                                <h3>Fetch you Semester Final Result</h3>
                                <hr>
                            </div>
                            <script>
                            ...
                            <div class="form-group">
                                <label for="reg_no" class="col-lg-2 control-label" > Registration No: </label>
                                <div class="col-lg-6">
                                    <input type="text" id="reg_no"  class="form-control" placeholder="Enter Your Reg no" name="reg" data-toggle="tooltip" data-placement="top" title="Registration No">
                                </div>
