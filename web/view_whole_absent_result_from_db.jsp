<%-- 
    Document   : view_whole_absent_result_from_db
    Created on : 29 Dec, 2015, 11:15:41 AM
    Author     : Tarequzzaman
--%>
                ...
                <center>
                    ...
                    <%
                        try {
                            ...
                            String sql = "select registration_no,course_id from absent where semester="+semester+" and session_='"+session_+"' order by course_id";
                            ResultSet rs;
