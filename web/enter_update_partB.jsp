...
<html>
    <head>
        ...
        <script>
            ...
            function myfunction()
            {
                ...
                if(marks==null || marks=="")
                {
                    document.getElementById("g").innerHTML="Enter a marks between 0 to 35";
                    data_true=1;
                }
    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="data">
                <center>
                    <form  action="update_partB_into_db.jsp" onsubmit="return myfunction()" method="post">
                        <table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input type="text" name="mark" placeholder="Enter marks" id="marks" style="width: 300px;height: 25px">
