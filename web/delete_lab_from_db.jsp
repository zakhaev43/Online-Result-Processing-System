<%-- 
    Document   : delete_lab_from_db
    Created on : 28 Dec, 2015, 12:23:07 PM
    Author     : Tarequzzaman
--%>
            ...
            <div class="mainmanu">
                ...
                <%
                    try {
                           ...
                           String sql = "delete from Lab where registration_no="+registration+" and course_id='"+course_id+"' and semester="+semester+" and session_='"+session_+"'";
