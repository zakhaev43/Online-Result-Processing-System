<%-- 
    Document   : delete_sesson_sem_for_result_public
    Created on : 11 Feb, 2016, 1:51:38 AM
    Author     : Tarequzzaman
--%>
         ...
         <%@ page import = "java.sql.*" %>  
                <%
                    try {
                        ...
                        String sql = "delete from result_published where session_='"+session_+"' and semester="+sem+"";
                        PreparedStatement ps = con.prepareStatement(sql);
                        ps.executeUpdate();
                        out.println("<center><h3>These session , semester are get private</h3></center>");
