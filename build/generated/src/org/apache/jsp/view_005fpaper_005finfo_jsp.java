...
public final class view_005fpaper_005finfo_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("            ");
                ...
                try {
                   ...
                   // SELECT * FROM table_name ORDER BY sortable_column DESC
                    String sql = "select * from paper_information order by count_paper desc";
                    ResultSet rs = st.executeQuery(sql);
            
      out.write("\n");
      out.write("        <table border=\"2px\" padding=\"2px\">\n");
      out.write("            <tr>\n");
      out.write("                <th>Paper_ID </th>\n");
      ...
      out.write("                ");
                  ...
                  out.println("<td>"+part+"</td>"); 
                   String session_ = rs.getString(5);
                  out.println("<td>"+session_+"</td>");
                    int sem = rs.getInt(6);
      ...
      out.write("                  <INPUT TYPE=\"button\" value=\"print\" class=\"no\" id=\"x\" onclick=\"myfunction()\">\n");
      out.write("            </div>\n");
      out.write("        </FORM>\n");
      out.write("        </div>\n");
      out.write("\n");
