...
public final class view_005fwhole_005fresult_005ffrom_005fdb_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("                    ");
                        ...
                        try {
                            ...
                            String sql = "select registration_no,course_id,marks_partA,marks_partB,marks_TT from partB full outer join partA using (course_id,registration_no,semester,session_) full outer join Termtest using (course_id,registration_no,semester,session_) order by course_id";
                            ResultSet rs;
      ...
      out.write("                            <th>Part A</th>\n");
      out.write("                            <th>Part B</th>\n");
