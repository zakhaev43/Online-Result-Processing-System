<%-- 
    Document   : enter_session_semester_for_view_whole_absent_result
    Created on : 29 Dec, 2015, 11:13:30 AM
    Author     : Tarequzzaman
--%>
   ...
   <div class="main">
            ...
            <div class="data">
                <center>
                    ...
                    <form action="view_whole_absent_result_from_db.jsp"  onsubmit="return myfunction()">
