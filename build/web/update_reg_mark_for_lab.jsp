<%-- 
    Document   : update_reg_mark_for_lab
    Created on : 28 Dec, 2015, 11:13:03 AM
    Author     : Tarequzzaman
--%>
<%@page import = "com.update_lab"%>
...
<html>
    ...
    if(marks=="" || marks==null)
        {
            document.getElementById("a").innerHTML="Enter marks between 0 to 100";
            data_true=1;
        }
    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="data">
                <center>
                    <form  action="update_lab" onsubmit="return myfunction()" method="post">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    <input type="text" name="marks" id="mark" placeholder="Enter updated mark For Lab" style="width: 300px;height: 25px">
                                    <span style="color:red;list-style:none;font-size:12px;font-weight:bold;"></span><br>
                                    <div>
