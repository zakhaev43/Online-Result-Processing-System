<%-- 
    Document   : enter_session_semester_for_view_whole_result
    Created on : 28 Dec, 2015, 7:55:58 PM
    Author     : Tarequzzaman
--%>
   ...
   <div class="main">
            ...
            <div class="data">
                <center>
                    ...
                    <form action="view_whole_result_from_db.jsp"  onsubmit="return myfunction()">
