...
<html>
    <head>
        ...
        <script>
            ...
            function myfunction()
            {
                ...
                if(marks==""|| marks==null)
                {
                    document.getElementById("z").innerHTML="please Enter A mark between 0 to 30";
                       data_true=1;             
                }
    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="data">
                <center>
                    <form  action="enter_termtest_into_db.jsp" onsubmit="return myfunction()">
                        <table>
                             <tr>
                                <td>
                               ...
                               <tr>
                                <td>
                                    ...
                                    <input type="text" name="marks" placeholder="Enter Term Test + Attendance  marks" id="mark" style="width: 300px;height: 25px">
                                    <span style="color:red;list-style:none;font-size:12px;font-weight:bold;"></span><br>
                                    <div>
