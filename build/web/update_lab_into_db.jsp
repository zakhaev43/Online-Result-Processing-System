<%-- 
    Document   : update_lab_into_db
    Created on : 28 Dec, 2015, 11:50:58 AM
    Author     : Tarequzzaman
--%>
            ...
            <div class="mainmanu">
                ...
                <%
                    try {
                           ...
                           String sql = "update Lab set  marks_lab="+marks+" where registration_no="+registration+" and course_id='"+course_id+"' and semester="+semester+" and session_='"+session_+"'";
