    ...
    <head>
     ...
     <body>
        <div class ="main">
            ...
            <div class="mainmanu">
               <%
               String regs=(String)request.getAttribute("registration");
            ...
            <%
                try {
                    ...
                    String sql = "delete from absent where registration_no="+reg+" and course_id='"+course_id+"' and session_='"+session_+"' and semester="+semester+"";
