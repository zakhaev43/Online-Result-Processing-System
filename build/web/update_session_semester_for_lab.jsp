<%-- 
    Document   : update_session_semester_for_lab
    Created on : 26 Dec, 2015, 5:18:43 PM
    Author     : Tarequzzaman
--%>
   ...
   <div class="main">
            ...
            <div class="data">
                <center>
                    ...
                    <form action="update_reg_mark_for_lab.jsp"  onsubmit="return myfunction()" method="post">
                            ...
                            <tr>
                                <td>
                                    <select name="course_id" class="drop_course" id="course">
                                        <option value="1" selected>Course ID</option>
                                         <%@ page import = "java.sql.*" %>  
                                         <%
