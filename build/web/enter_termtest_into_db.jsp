            ...
            <div class="mainmanu">
                ...
                <%
                    try {
                        ...
                        String sql = "insert into Termtest(registration_no,session_,semester,course_id,marks_TT,count_TT) values("+ registration_no + ",'" + session_ + "'," + semester + ",'" + course_id + "'," + marks + ",TT_tag.nextval)";
