<%-- 
    Document   : update_partA
    Created on : 21 Dec, 2015, 2:05:58 PM
    Author     : Tarequzzaman
--%>
<%@ page import="com.partA"%>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" name="paper_id" id="reg" placeholder="Paper Id" style="width: 300px;height: 25px">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" name="marks" id="marks" placeholder="Marks" style="width: 300px;height: 25px">
                                        <span style="color:red;list-style:none;font-size:12px;font-weight:bold;"></span><br>
                                        <div>
