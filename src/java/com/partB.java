 ...
 * @author Tarequzzaman
 */
@WebServlet(name = "partB", urlPatterns = {"/partB"})
public class partB extends HttpServlet {
        ...
        try {
            ...
            Class.forName("oracle.jdbc.driver.OracleDriver");
                ...
                request.setAttribute("session", session_);
                 ...
                 request.setAttribute("marks", mark);
                long paper= Long.parseLong(ss);               
                String sql = "SELECT paper_id from partB where session_='"+session_+"' and semester="+semester+"";
                ...
                while(rs.next())      
                {
                     ...
                     if(paper_id==paper)
                     {
                        request.getRequestDispatcher("update_partB_into_db.jsp").forward(request, response);
                         response.sendRedirect("update_partB_into_db.jsp");
                      cou=1;
                         break;
                     }
