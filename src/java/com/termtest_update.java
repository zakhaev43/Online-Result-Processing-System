 ...
 * @author Tarequzzaman
 */
@WebServlet(name = "termtest_update", urlPatterns = {"/termtest_update"})
public class termtest_update extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String sql = "SELECT registration_no from Termtest where session_='" + session_ + "' and semester=" + semester + " and course_id='" + course_id + "'";
                ...
                while (rs.next()) {
                    long student_id = rs.getInt(1);
                     ...
                     request.getRequestDispatcher("update_termtest_into_db.jsp").forward(request, response);
                    response.sendRedirect("update_termtest_into_db.jsp");
                      cou = 1;
                      break;
                     }
