 ...
 * @author Tarequzzaman
 */
@WebServlet(name = "partA", urlPatterns = {"/partA"})
public class partA extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
             try {
                ...
                String sql = "SELECT paper_id from partA where session_='"+session_+"' and semester="+semester+"";
                ...
                while(rs.next())      
                {
                     ...
                     if(paper_id==paper)
                     {
                        request.getRequestDispatcher("update_partA_into_db.jsp").forward(request, response);
                        response.sendRedirect("update_partA_into_db.jsp");
                        cou=1;
                         break;
                     }
